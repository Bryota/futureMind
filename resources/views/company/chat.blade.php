@extends('layouts.layout_chat_company')
@section('content')
    <main>
    <div class="chat_wrap">
            <div class="container">
            <h3 class="chat_title">チャット</h3>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="message_wrap message_wrap_company" id="message_wrap">
                        </div>
                    </div>
                ...
                <form action="{{route('company.postMessage',['id'=>$room_id, 'student_id' => $student_user->id])}}" method="POST" class="chat_form_wrap">
                    @csrf
