...
<main>
    <div class="admin_wrap">
        <div class="container">
            <h3 class="page_title">理想分析会社コメント</h3>
            <table class="table admin_comment_list_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.future_company_edit', ['id' => $comment->id ]) }}" class="btn btn_edit">編集</a>
                            <form method="POST" action="{{ route('admin.future_company_delete', ['id' => $comment->id ]) }}">
                                @method('DELETE')
                                @csrf
