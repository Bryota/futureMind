...
<main>
    <div class="admin_wrap">
        <div class="container">
            <h3 class="page_title">自己分析コメント</h3>
            <table class="table admin_comment_list_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.self_edit', ['id' => $comment->id ]) }}" class="btn btn_edit">編集</a>
                            <form method="POST" action="{{ route('admin.self_delete', ['id' => $comment->id ]) }}">
                                @method('DELETE')
                                @csrf
