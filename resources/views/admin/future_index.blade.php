...
<main>
    <div class="admin_wrap">
        <div class="container">
            <h3 class="page_title">理想分析コメント</h3>
            <table class="table admin_comment_list_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.future_edit', ['id' => $comment->id ]) }}" class="btn btn_edit">編集</a>
                            <form method="POST" action="{{ route('admin.future_delete', ['id' => $comment->id ]) }}">
                                @method('DELETE')
                                @csrf
