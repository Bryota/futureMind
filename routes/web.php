...
Route::group(['namespace' => 'admin', 'prefix' => 'admin'], function () {
    Route::get('/import_diagnosis_qiestion', [App\Http\Controllers\admin\ImportCSVController::class, 'index'])->name('admin.import_diagnosis_question');
    Route::post('/import_diagnosis_qiestion', [App\Http\Controllers\admin\ImportCSVController::class, 'store']);
});
